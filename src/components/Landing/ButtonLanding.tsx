...
function ButtonLanding({ scroll }: Props) {
    ...
    return (
        <>
            <div data-aos='fade-right' data-aos-delay='1500' data-aos-once="true" className={`${layout} left-0 lg:left-20 top-32`}>
            ...
            <div data-aos='fade-left' data-aos-delay='1500' data-aos-once="true" className={`${layout} flex justify-end right-0 lg:right-20 top-1/3`}>
                <div className={`${hover} relative flex justify-center items-center w-[70px] md:w-[100px] lg:w-[150px]`}>
            ...
            <div data-aos='fade-right' data-aos-delay='0' data-aos-once="true" className={`${layout} left-0 lg:left-20 bottom-20 md:bottom-10`}>
                <div className={`${hover} relative flex justify-center items-center w-[70px] md:w-[100px] lg:w-[150px]`}>
